...
pdbchAname = (opts.npz).split('/')[-1].replace('prediction_','')[:-4]+'_chA.pdb'
chainA_path = f'/home/swang523/Crystal_engineering/RPXdock_playground/1comp_chlorphyll/I2_chlorophyll/output/design_output/selected/chA/rainity/{pdbchAname}'
